...
module TalonOne
  class IntegrationApi
    ...
    # @option opts [CouponReservations] :body 
    # @return [Coupon]
    def create_coupon_reservation(coupon_value, opts = {})
      data, _status_code, _headers = create_coupon_reservation_with_http_info(coupon_value, opts)
      data
    end
    ...
    def create_coupon_reservation_with_http_info(coupon_value, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [NewReferral] :body 
    # @return [Referral]
    def create_referral(opts = {})
      data, _status_code, _headers = create_referral_with_http_info(opts)
      data
    end
    ...
    def create_referral_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [CouponReservations] :body 
    # @return [nil]
    def delete_coupon_reservation(coupon_value, opts = {})
      delete_coupon_reservation_with_http_info(coupon_value, opts)
      nil
    end
    ...
    def delete_coupon_reservation_with_http_info(coupon_value, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [NewEvent] :body 
    # @return [IntegrationState]
    def track_event(opts = {})
      data, _status_code, _headers = track_event_with_http_info(opts)
      data
    end
    ...
    def track_event_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @param integration_id The custom identifier for this profile, must be unique within the account.
    # @param [Hash] opts the optional parameters
    # @option opts [NewCustomerProfile] :body 
    # @return [IntegrationState]
    def update_customer_profile(integration_id, opts = {})
      data, _status_code, _headers = update_customer_profile_with_http_info(integration_id, opts)
      data
    end
    ...
    # @option opts [NewCustomerProfile] :body 
    # @return [Array<(IntegrationState, Fixnum, Hash)>] IntegrationState data, response status code and response headers
    def update_customer_profile_with_http_info(integration_id, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [NewCustomerSession] :body 
    # @return [IntegrationState]
    def update_customer_session(customer_session_id, opts = {})
      data, _status_code, _headers = update_customer_session_with_http_info(customer_session_id, opts)
      data
    end
    ...
    # @option opts [NewCustomerSession] :body 
    # @return [Array<(IntegrationState, Fixnum, Hash)>] IntegrationState data, response status code and response headers
    def update_customer_session_with_http_info(customer_session_id, opts = {})
      if @api_client.config.debugging
