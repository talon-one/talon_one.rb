...
module TalonOne
  class UpdateUser
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'release_update')
        self.release_update = attributes[:'release_update']
      end
    ...
    def hash
      [name, policy, state, release_update, latest_feature, roles, application_notification_subscriptions].hash
    end
