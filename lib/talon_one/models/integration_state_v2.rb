...
module TalonOne
  ...
  class IntegrationStateV2
    ...
    def hash
      [customer_profile, loyalty, triggered_campaigns, campaign_eligibility, effects, rule_failure_reasons, created_coupons, created_referrals, awarded_giveaways, achievements, rewards, referral, coupons, event, advanced_event, customer_session, _return, previous_returns].hash
    end
