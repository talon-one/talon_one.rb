  ...
  class NewDigitalPass
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TalonOne::NewDigitalPass` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::NewDigitalPass`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @pass_template_id.to_s.length < 1
        invalid_properties.push('invalid value for "pass_template_id", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @pass_template_id.to_s.length < 1
      return false if @profile_id.nil?
      return false if @profile_id.to_s.length < 1
      return false if @platform.nil?
      platform_validator = EnumAttributeValidator.new('String', ["apple", "google"])
    ...
    def pass_template_id=(pass_template_id)
      ...
      if pass_template_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "pass_template_id", the character length must be great than or equal to 1.'
      end
    ...
    def platform=(platform)
      validator = EnumAttributeValidator.new('String', ["apple", "google"])
    ...
    def hash
      [loyalty_program_id, pass_template_id, profile_id, loyalty_card_id, platform, attributes].hash
    end
