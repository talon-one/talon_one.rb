...
module TalonOne
  ...
  class LedgerInfo
    ...
    def hash
      [current_balance, pending_balance, expired_balance, spent_balance, tentative_current_balance, tentative_pending_balance, current_tier, points_to_next_tier].hash
    end
