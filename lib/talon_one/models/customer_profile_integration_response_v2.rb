...
module TalonOne
  ...
  class CustomerProfileIntegrationResponseV2
    ...
    def hash
      [customer_profile, event, loyalty, triggered_campaigns, rule_failure_reasons, campaign_eligibility, awarded_giveaways, rewards, effects, created_coupons, created_referrals].hash
    end
