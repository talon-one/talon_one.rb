...
module TalonOne
  class IntegrationHubEventPayloadLoyaltyProfileBasedTierUpgradeNotification
    ...
    def hash
      [profile_integration_id, loyalty_program_id, subledger_id, source_of_event, current_tier, current_points, old_tier, points_required_to_the_next_tier, next_tier, tier_expiration_date, timestamp_of_tier_change, published_at].hash
    end
