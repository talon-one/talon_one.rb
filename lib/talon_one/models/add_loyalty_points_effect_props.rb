...
module TalonOne
  ...
  class AddLoyaltyPointsEffectProps
    ...
    attr_accessor :expiry_condition
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'expiry_condition')
        self.expiry_condition = attributes[:'expiry_condition']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expiry_condition == o.expiry_condition
    end
    ...
    def hash
      [name, program_id, sub_ledger_id, value, recipient_integration_id, expiry_condition].hash
    end
