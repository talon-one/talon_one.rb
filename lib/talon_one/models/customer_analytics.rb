...
module TalonOne
  ...
  class CustomerAnalytics
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'acceptedCoupons')
        self.accepted_coupons = attributes[:'acceptedCoupons']
      end

      if attributes.has_key?(:'createdCoupons')
        self.created_coupons = attributes[:'createdCoupons']
      end

      if attributes.has_key?(:'freeItems')
        self.free_items = attributes[:'freeItems']
      end
      ...
      if attributes.has_key?(:'totalDiscountedOrders')
        self.total_discounted_orders = attributes[:'totalDiscountedOrders']
      end

      if attributes.has_key?(:'totalRevenue')
        self.total_revenue = attributes[:'totalRevenue']
      end

      if attributes.has_key?(:'totalDiscounts')
        self.total_discounts = attributes[:'totalDiscounts']
      end
    end
