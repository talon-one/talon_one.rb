  ...
  class CampaignEditedNotificationItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TalonOne::CampaignEditedNotificationItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::CampaignEditedNotificationItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'old_campaign')
        self.old_campaign = attributes[:'old_campaign']
      end
    ...
    def list_invalid_properties
      ...
      if @old_campaign.nil?
        invalid_properties.push('invalid value for "old_campaign", old_campaign cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @old_campaign.nil?
      true
    end
    ...
    def hash
      [event, campaign, old_campaign, ruleset, placeholders].hash
    end
