...
module TalonOne
  ...
  class LoyaltyLedgerEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'customerProfileID')
        self.customer_profile_id = attributes[:'customerProfileID']
      end

      if attributes.has_key?(:'customerSessionID')
        self.customer_session_id = attributes[:'customerSessionID']
      end
