...
module TalonOne
  class Store
    ...
    attr_accessor :linked_campaign_ids
    ...
    def self.openapi_types
      {
        ...
        :'updated' => :'DateTime',
        :'linked_campaign_ids' => :'Array<Integer>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TalonOne::Store` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TalonOne::Store`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'linked_campaign_ids')
        if (value = attributes[:'linked_campaign_ids']).is_a?(Array)
          self.linked_campaign_ids = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          updated == o.updated &&
          linked_campaign_ids == o.linked_campaign_ids
    end
    ...
    def hash
      [id, created, name, description, attributes, integration_id, application_id, updated, linked_campaign_ids].hash
    end
