...
module TalonOne
  class NewCampaign
    ...
    def hash
      [name, description, start_time, end_time, attributes, state, active_ruleset_id, tags, reevaluate_on_return, features, coupon_settings, referral_settings, limits, campaign_groups, type, linked_store_ids, coupon_attributes, evaluation_group_id].hash
    end
