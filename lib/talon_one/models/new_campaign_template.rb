...
module TalonOne
  class NewCampaignTemplate
    ...
    def hash
      [name, description, instructions, campaign_attributes, coupon_attributes, state, tags, features, coupon_settings, referral_settings, limits, template_params, campaign_collections].hash
    end
