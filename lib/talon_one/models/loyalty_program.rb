...
module TalonOne
  ...
  class LoyaltyProgram
    ...
    def hash
      [id, created, title, description, subscribed_applications, default_validity, default_pending, allow_subledger, users_per_card_limit, account_id, name, tiers, timezone, card_based].hash
    end
