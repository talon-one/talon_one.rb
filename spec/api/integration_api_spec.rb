...
describe 'IntegrationApi' do
  ...
  # unit tests for activate_loyalty_points
  ...
  # @param loyalty_program_id The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. 
  # @param body body
  # @param [Hash] opts the optional parameters
  # @return [ActivateLoyaltyPointsResponse]
  describe 'activate_loyalty_points test' do
    it 'should work' do
  ...
  # unit tests for delete_loyalty_transactions_from_ledgers
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_loyalty_transactions_from_ledgers test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for get_event_v3
  # Get advanced event
  # Retrieve an advanced event by its identifier. 
  # @param integration_id The unique ID of the advanced event.
  # @param [Hash] opts the optional parameters
  # @return [EventV3]
  describe 'get_event_v3 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for integration_get_all_campaigns
  ...
  describe 'integration_get_all_campaigns test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for integration_rewards_catalog
  ...
  # unit tests for join_loyalty_program
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'join_loyalty_program test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'track_event_v3 test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for unlink_loyalty_card_from_profile
  ...
  # @param loyalty_program_id The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. 
  # @param loyalty_card_id The identifier of the loyalty card. You can get this ID using the [List loyalty cards](https://docs.talon.one/management-api#tag/Loyalty-cards/operation/getLoyaltyCards) endpoint.  **Important**: The loyalty card ID requires [URL encoding](https://www.w3schools.com/tags//ref_urlencode.asp) if it contains special characters. For example, you must encode &#x60;NewCard2026%&#x60; as &#x60;NewCard2026%25&#x60;. 
  # @param body body
  # @param [Hash] opts the optional parameters
  # @return [LoyaltyCard]
  describe 'unlink_loyalty_card_from_profile test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for unlock_reward
  # Unlock a reward
  ...
  # @param reward_id The ID of the reward. You can get the ID with the [List rewards](#tag/Rewards/operation/listRewards) endpoint.
  # @param body 
  # @param [Hash] opts the optional parameters
