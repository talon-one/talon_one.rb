...
# Unit tests for TalonOne::ResponseContentObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ResponseContentObject' do
  before do
  ...
  describe 'test an instance of ResponseContentObject' do
    it 'should create an instance of ResponseContentObject' do
      expect(@instance).to be_instance_of(TalonOne::ResponseContentObject)
    end
  end
