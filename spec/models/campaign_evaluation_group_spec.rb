...
# Unit tests for TalonOne::CampaignEvaluationGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CampaignEvaluationGroup' do
  before do
    # run before each test
    @instance = TalonOne::CampaignEvaluationGroup.new
  end
  ...
  describe 'test an instance of CampaignEvaluationGroup' do
    it 'should create an instance of CampaignEvaluationGroup' do
      expect(@instance).to be_instance_of(TalonOne::CampaignEvaluationGroup)
    end
  end
