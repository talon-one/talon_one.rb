...
# Unit tests for TalonOne::CampaignEligibility
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CampaignEligibility' do
  before do
  ...
  describe 'test an instance of CampaignEligibility' do
    it 'should create an instance of CampaignEligibility' do
      expect(@instance).to be_instance_of(TalonOne::CampaignEligibility)
    end
  end
