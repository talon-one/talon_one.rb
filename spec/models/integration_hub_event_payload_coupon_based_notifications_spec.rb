...
# Unit tests for TalonOne::IntegrationHubEventPayloadCouponBasedNotifications
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IntegrationHubEventPayloadCouponBasedNotifications' do
  before do
  ...
  describe 'test an instance of IntegrationHubEventPayloadCouponBasedNotifications' do
    it 'should create an instance of IntegrationHubEventPayloadCouponBasedNotifications' do
      expect(@instance).to be_instance_of(TalonOne::IntegrationHubEventPayloadCouponBasedNotifications)
    end
  end
