...
# Unit tests for TalonOne::AchievementBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AchievementBase' do
  before do
    # run before each test
    @instance = TalonOne::AchievementBase.new
  end
  ...
  describe 'test an instance of AchievementBase' do
    it 'should create an instance of AchievementBase' do
      expect(@instance).to be_instance_of(TalonOne::AchievementBase)
    end
  end
