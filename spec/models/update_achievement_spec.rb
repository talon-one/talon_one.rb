...
# Unit tests for TalonOne::UpdateAchievement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateAchievement' do
  before do
    # run before each test
    @instance = TalonOne::UpdateAchievement.new
  end
  ...
  describe 'test an instance of UpdateAchievement' do
    it 'should create an instance of UpdateAchievement' do
      expect(@instance).to be_instance_of(TalonOne::UpdateAchievement)
    end
  end
