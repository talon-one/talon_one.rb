...
# Unit tests for TalonOne::CustomerAchievement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomerAchievement' do
  before do
  ...
  describe 'test an instance of CustomerAchievement' do
    it 'should create an instance of CustomerAchievement' do
      expect(@instance).to be_instance_of(TalonOne::CustomerAchievement)
    end
  end
