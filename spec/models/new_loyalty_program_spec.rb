...
# Unit tests for TalonOne::NewLoyaltyProgram
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NewLoyaltyProgram' do
  before do
  ...
  describe 'test an instance of NewLoyaltyProgram' do
    it 'should create an instance of NewLoyaltyProgram' do
      expect(@instance).to be_instance_of(TalonOne::NewLoyaltyProgram)
    end
  end
  ...
  describe 'test attribute "card_based"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
