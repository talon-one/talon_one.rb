...
# Unit tests for TalonOne::IntegrationCampaignBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IntegrationCampaignBase' do
  before do
  ...
  describe 'test an instance of IntegrationCampaignBase' do
    it 'should create an instance of IntegrationCampaignBase' do
      expect(@instance).to be_instance_of(TalonOne::IntegrationCampaignBase)
    end
  end
