...
# Unit tests for TalonOne::CampaignNotificationBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CampaignNotificationBase' do
  before do
  ...
  describe 'test an instance of CampaignNotificationBase' do
    it 'should create an instance of CampaignNotificationBase' do
      expect(@instance).to be_instance_of(TalonOne::CampaignNotificationBase)
    end
  end
