...
# Unit tests for TalonOne::CreateAchievementV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateAchievementV2' do
  before do
    # run before each test
    @instance = TalonOne::CreateAchievementV2.new
  end
  ...
  describe 'test an instance of CreateAchievementV2' do
    it 'should create an instance of CreateAchievementV2' do
      expect(@instance).to be_instance_of(TalonOne::CreateAchievementV2)
    end
  end
