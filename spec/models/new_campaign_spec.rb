...
# Unit tests for TalonOne::NewCampaign
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NewCampaign' do
  before do
    # run before each test
    @instance = TalonOne::NewCampaign.new
  end
  ...
  describe 'test an instance of NewCampaign' do
    it 'should create an instance of NewCampaign' do
      expect(@instance).to be_instance_of(TalonOne::NewCampaign)
    end
  end
