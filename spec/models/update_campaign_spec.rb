...
# Unit tests for TalonOne::UpdateCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateCampaign' do
  before do
    # run before each test
    @instance = TalonOne::UpdateCampaign.new
  end
  ...
  describe 'test an instance of UpdateCampaign' do
    it 'should create an instance of UpdateCampaign' do
      expect(@instance).to be_instance_of(TalonOne::UpdateCampaign)
    end
  end
