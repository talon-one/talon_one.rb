...
# Unit tests for TalonOne::AchievementBaseV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AchievementBaseV2' do
  before do
    # run before each test
    @instance = TalonOne::AchievementBaseV2.new
  end
  ...
  describe 'test an instance of AchievementBaseV2' do
    it 'should create an instance of AchievementBaseV2' do
      expect(@instance).to be_instance_of(TalonOne::AchievementBaseV2)
    end
  end
