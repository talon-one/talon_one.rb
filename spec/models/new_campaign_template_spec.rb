...
# Unit tests for TalonOne::NewCampaignTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NewCampaignTemplate' do
  before do
    # run before each test
    @instance = TalonOne::NewCampaignTemplate.new
  end
  ...
  describe 'test an instance of NewCampaignTemplate' do
    it 'should create an instance of NewCampaignTemplate' do
      expect(@instance).to be_instance_of(TalonOne::NewCampaignTemplate)
    end
  end
