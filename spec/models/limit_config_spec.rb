...
# Unit tests for TalonOne::LimitConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LimitConfig' do
  before do
    # run before each test
    @instance = TalonOne::LimitConfig.new
  end
  ...
  describe 'test an instance of LimitConfig' do
    it 'should create an instance of LimitConfig' do
      expect(@instance).to be_instance_of(TalonOne::LimitConfig)
    end
  end
