...
# Unit tests for TalonOne::ExpiringCouponsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpiringCouponsData' do
  before do
  ...
  describe 'test an instance of ExpiringCouponsData' do
    it 'should create an instance of ExpiringCouponsData' do
      expect(@instance).to be_instance_of(TalonOne::ExpiringCouponsData)
    end
  end
