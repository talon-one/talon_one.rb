...
# Unit tests for TalonOne::UpdateLoyaltyProgram
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateLoyaltyProgram' do
  before do
    # run before each test
    @instance = TalonOne::UpdateLoyaltyProgram.new
  end
  ...
  describe 'test an instance of UpdateLoyaltyProgram' do
    it 'should create an instance of UpdateLoyaltyProgram' do
      expect(@instance).to be_instance_of(TalonOne::UpdateLoyaltyProgram)
    end
  end
