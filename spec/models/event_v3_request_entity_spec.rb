...
# Unit tests for TalonOne::EventV3RequestEntity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EventV3RequestEntity' do
  before do
  ...
  describe 'test an instance of EventV3RequestEntity' do
    it 'should create an instance of EventV3RequestEntity' do
      expect(@instance).to be_instance_of(TalonOne::EventV3RequestEntity)
    end
  end
