...
# Unit tests for TalonOne::AchievementV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AchievementV2' do
  before do
    # run before each test
    @instance = TalonOne::AchievementV2.new
  end
  ...
  describe 'test an instance of AchievementV2' do
    it 'should create an instance of AchievementV2' do
      expect(@instance).to be_instance_of(TalonOne::AchievementV2)
    end
  end
