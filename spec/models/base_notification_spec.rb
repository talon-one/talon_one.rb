...
# Unit tests for TalonOne::BaseNotification
...
describe 'BaseNotification' do
  ...
  describe 'test an instance of BaseNotification' do
    it 'should create an instance of BaseNotification' do
      expect(@instance).to be_instance_of(TalonOne::BaseNotification)
    end
  end
