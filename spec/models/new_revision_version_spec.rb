...
# Unit tests for TalonOne::NewRevisionVersion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'NewRevisionVersion' do
  before do
    # run before each test
    @instance = TalonOne::NewRevisionVersion.new
  end
  ...
  describe 'test an instance of NewRevisionVersion' do
    it 'should create an instance of NewRevisionVersion' do
      expect(@instance).to be_instance_of(TalonOne::NewRevisionVersion)
    end
  end
