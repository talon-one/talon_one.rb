...
# Unit tests for TalonOne::TalangAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TalangAttribute' do
  before do
    # run before each test
    @instance = TalonOne::TalangAttribute.new
  end
  ...
  describe 'test an instance of TalangAttribute' do
    it 'should create an instance of TalangAttribute' do
      expect(@instance).to be_instance_of(TalonOne::TalangAttribute)
    end
  end
