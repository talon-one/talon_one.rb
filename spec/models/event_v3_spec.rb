...
# Unit tests for TalonOne::EventV3
...
describe 'EventV3' do
  ...
  describe 'test an instance of EventV3' do
    it 'should create an instance of EventV3' do
      expect(@instance).to be_instance_of(TalonOne::EventV3)
    end
  end
