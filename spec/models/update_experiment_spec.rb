...
# Unit tests for TalonOne::UpdateExperiment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateExperiment' do
  before do
  ...
  describe 'test an instance of UpdateExperiment' do
    it 'should create an instance of UpdateExperiment' do
      expect(@instance).to be_instance_of(TalonOne::UpdateExperiment)
    end
  end
