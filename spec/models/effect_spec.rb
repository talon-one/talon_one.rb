...
# Unit tests for TalonOne::Effect
...
describe 'Effect' do
  ...
  describe 'test an instance of Effect' do
    it 'should create an instance of Effect' do
      expect(@instance).to be_instance_of(TalonOne::Effect)
    end
  end
