...
# Unit tests for TalonOne::UpdateAchievementV2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateAchievementV2' do
  before do
    # run before each test
    @instance = TalonOne::UpdateAchievementV2.new
  end
  ...
  describe 'test an instance of UpdateAchievementV2' do
    it 'should create an instance of UpdateAchievementV2' do
      expect(@instance).to be_instance_of(TalonOne::UpdateAchievementV2)
    end
  end
