...
# Unit tests for TalonOne::RevisionVersion
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RevisionVersion' do
  before do
  ...
  describe 'test an instance of RevisionVersion' do
    it 'should create an instance of RevisionVersion' do
      expect(@instance).to be_instance_of(TalonOne::RevisionVersion)
    end
  end
