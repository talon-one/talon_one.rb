...
# Unit tests for TalonOne::UpdateCampaignEvaluationGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'UpdateCampaignEvaluationGroup' do
  before do
    # run before each test
    @instance = TalonOne::UpdateCampaignEvaluationGroup.new
  end
  ...
  describe 'test an instance of UpdateCampaignEvaluationGroup' do
    it 'should create an instance of UpdateCampaignEvaluationGroup' do
      expect(@instance).to be_instance_of(TalonOne::UpdateCampaignEvaluationGroup)
    end
  end
