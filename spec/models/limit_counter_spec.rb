...
# Unit tests for TalonOne::LimitCounter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LimitCounter' do
  before do
    # run before each test
    @instance = TalonOne::LimitCounter.new
  end
  ...
  describe 'test an instance of LimitCounter' do
    it 'should create an instance of LimitCounter' do
      expect(@instance).to be_instance_of(TalonOne::LimitCounter)
    end
  end
