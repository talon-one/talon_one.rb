...
# Unit tests for TalonOne::CouponWithApplication
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CouponWithApplication' do
  before do
    # run before each test
    @instance = TalonOne::CouponWithApplication.new
  end
  ...
  describe 'test an instance of CouponWithApplication' do
    it 'should create an instance of CouponWithApplication' do
      expect(@instance).to be_instance_of(TalonOne::CouponWithApplication)
    end
  end
