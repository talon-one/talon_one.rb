...
# Unit tests for TalonOne::Achievement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Achievement' do
  before do
    # run before each test
    @instance = TalonOne::Achievement.new
  end
  ...
  describe 'test an instance of Achievement' do
    it 'should create an instance of Achievement' do
      expect(@instance).to be_instance_of(TalonOne::Achievement)
    end
  end
