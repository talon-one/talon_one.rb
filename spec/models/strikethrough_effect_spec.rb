...
# Unit tests for TalonOne::StrikethroughEffect
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StrikethroughEffect' do
  before do
  ...
  describe 'test an instance of StrikethroughEffect' do
    it 'should create an instance of StrikethroughEffect' do
      expect(@instance).to be_instance_of(TalonOne::StrikethroughEffect)
    end
  end
