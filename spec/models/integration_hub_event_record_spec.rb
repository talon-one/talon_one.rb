...
# Unit tests for TalonOne::IntegrationHubEventRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IntegrationHubEventRecord' do
  before do
  ...
  describe 'test an instance of IntegrationHubEventRecord' do
    it 'should create an instance of IntegrationHubEventRecord' do
      expect(@instance).to be_instance_of(TalonOne::IntegrationHubEventRecord)
    end
  end
