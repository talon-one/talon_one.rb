...
# Unit tests for TalonOne::AchievementReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AchievementReference' do
  before do
  ...
  describe 'test an instance of AchievementReference' do
    it 'should create an instance of AchievementReference' do
      expect(@instance).to be_instance_of(TalonOne::AchievementReference)
    end
  end
