...
# Unit tests for TalonOne::CampaignStoreBudgetLimitConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CampaignStoreBudgetLimitConfig' do
  before do
    # run before each test
    @instance = TalonOne::CampaignStoreBudgetLimitConfig.new
  end
  ...
  describe 'test an instance of CampaignStoreBudgetLimitConfig' do
    it 'should create an instance of CampaignStoreBudgetLimitConfig' do
      expect(@instance).to be_instance_of(TalonOne::CampaignStoreBudgetLimitConfig)
    end
  end
