...
# Unit tests for TalonOne::LoyaltyProgramTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LoyaltyProgramTransaction' do
  before do
  ...
  describe 'test an instance of LoyaltyProgramTransaction' do
    it 'should create an instance of LoyaltyProgramTransaction' do
      expect(@instance).to be_instance_of(TalonOne::LoyaltyProgramTransaction)
    end
  end
