...
# Unit tests for TalonOne::CreateAchievement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateAchievement' do
  before do
    # run before each test
    @instance = TalonOne::CreateAchievement.new
  end
  ...
  describe 'test an instance of CreateAchievement' do
    it 'should create an instance of CreateAchievement' do
      expect(@instance).to be_instance_of(TalonOne::CreateAchievement)
    end
  end
