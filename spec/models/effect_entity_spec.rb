...
# Unit tests for TalonOne::EffectEntity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EffectEntity' do
  before do
  ...
  describe 'test an instance of EffectEntity' do
    it 'should create an instance of EffectEntity' do
      expect(@instance).to be_instance_of(TalonOne::EffectEntity)
    end
  end
  ...
  describe 'test attribute "effect_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "triggered_for_catalog_item"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "selected_price"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
