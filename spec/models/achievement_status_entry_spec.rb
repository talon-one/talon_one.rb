...
# Unit tests for TalonOne::AchievementStatusEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AchievementStatusEntry' do
  before do
    # run before each test
    @instance = TalonOne::AchievementStatusEntry.new
  end
  ...
  describe 'test an instance of AchievementStatusEntry' do
    it 'should create an instance of AchievementStatusEntry' do
      expect(@instance).to be_instance_of(TalonOne::AchievementStatusEntry)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["active", "scheduled"])
      # validator.allowable_values.each do |value|
