...
# Unit tests for TalonOne::CustomerProfileReward
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomerProfileReward' do
  before do
  ...
  describe 'test an instance of CustomerProfileReward' do
    it 'should create an instance of CustomerProfileReward' do
      expect(@instance).to be_instance_of(TalonOne::CustomerProfileReward)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unlocked", "used"])
  ...
  describe 'test attribute "unlocked_at"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
