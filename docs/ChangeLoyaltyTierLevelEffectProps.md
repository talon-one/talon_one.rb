...
**program_id** | **Integer** | The ID of the loyalty program where the points were added. | 
**sub_ledger_id** | **String** | The ID of the subledger within the loyalty program where the points were added. | 
