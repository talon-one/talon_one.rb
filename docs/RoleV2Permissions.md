...
**thresholds** | [**Array&lt;RolesV2Thresholds&gt;**](RolesV2Thresholds.md) | Support user limits for actions that require admin approval within the given application. | [optional] 
