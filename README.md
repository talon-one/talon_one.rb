...
### Where is the API?
The API is available at the same hostname as your deployment. For example, if you are accessing Talon.One's Campaign Manager at `https://mycompany.talon.one/`, the URL for the [updateCustomerProfile](docs/IntegrationApi.md#update_customer_profile) operation is `https://mycompany.talon.one/v1/customer_profiles/integraion_id`
...
```shell
gem install ./talon_one-.gem
```
(for development, run `gem install --dev ./talon_one-.gem` to install the development dependencies)
...
*TalonOne::ManagementApi* | [**get_campaign_set**](docs/ManagementApi.md#get_campaign_set) | **GET** /v1/applications/{applicationId}/campaign_set | List CampaignSet
...
*TalonOne::ManagementApi* | [**refresh_analytics**](docs/ManagementApi.md#refresh_analytics) | **POST** /v1/refresh_analytics | Trigger refresh on stale analytics.
